...
#-----------------------------------------------------------------------------------------------------------------------------
#--------------------------------------------------------------------
def encodeF(Name,engI=2,symI=1,numI=1,hold=['a','e'],igPtrn=2):
	print("encrypting ... ")
	inputFileName=Name.split('.')[0]
	outputFileName=inputFileName+"_encrypted.txt"
	...
	out.close()
	inp.close()
	print("crypted file is created as {0}\n".format(outputFileName))
# working fine 
# encodeF("simple.txt",engI=-1,symI=0,numI=0,hold=[],igPtrn=0)
import sys
encodeF(sys.argv[1],engI=5,symI=1,numI=2,hold=[],igPtrn=1)
